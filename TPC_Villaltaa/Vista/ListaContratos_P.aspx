<%@ Page Title="" Language="C#" MasterPageFile="~/Site2.Master" AutoEventWireup="true" CodeBehind="ListaContratos_P.aspx.cs" Inherits="Vista.ListaContratos_P" %>
...
<div class="card-columns" style="margin-left: 10px; margin-right: 10px;">
    <%foreach (var item in ListaContratoP)
        { %>
        <div class="card">
            <img src="HTML/img/025-user.png">
            <div class="card-body">                                       
                <p class="card-text">Id Contrato: <% = item.IdContrato %></p>
            ...
            <a class="btn btn-primary" href="VerContrato_P.aspx?idcontrato=<% = item.IdContrato%>">Ver</a>                 
        </div>
    <%} %>
</div>
